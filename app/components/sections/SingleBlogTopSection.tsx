...
export const SingleBlogTopSection = () => {
  ...
  return(
    ...
    <div className="bg-gradient-to-r from-[#000000] to-[#0F2248] bg-gradient-to-b from-[#0F2248] to-[#000008B]relative z-10 flex items-center justify-center h-[990px] [@media(max-width:1300px)]:flex-col [@media(max-width:1300px)]:text-center [@media(max-width:1300px)]:gap-2">
      ...
      <div>
        {/*for social icons */}
         <div className="flex items-center gap-4 pt-4 border-[#84B5FFC2] lg:left-[341px] lg:-top-[150px] lg:relative [@media(max-width:1300px)]:relative [@media(max-width:1300px)]:left-[190px]">
            <a
              href="https://whatsapp.com/channel/0029Vb5rS68HLHQXvaWJM13c"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#84B5FFC2] hover:text-white transition-colors"
              aria-label="WhatsApp"
            >
                <svg
                  className="w-5 h-5"
            ...
            <a
              href="https://www.linkedin.com/company/cssl-genz-chapter-of-ucsc/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#84B5FFC2] hover:text-white transition-colors"
              aria-label="LinkedIn"
            ...
            <a
              href="https://www.facebook.com/share/1F5rcLY4fd/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#84B5FFC2] hover:text-white transition-colors"
              aria-label="Facebook"
            ...
            <a
              href="https://www.instagram.com/cssl_ucsc"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#84B5FFC2] hover:text-white transition-colors"
          ...
          <h1 className="text-5xl  font-[490] text-white lg:left-[50px] lg:-top-[80px] lg:relative ">
              {blog?.title}
          </h1>

          <div className="flex flex-row gap-4 lg:left-[50px] lg:-top-[10px] lg:relative [@media(max-width:1300px)]:relative [@media(max-width:1300px)]:top-[30px] [@media(max-width:1300px)]:left-[31px]">
              <svg
