...
export function EventsSection({ events }: EventsSectionProps) {
  ...
  return (
    <main
      ...
      className={`${isSticky && !hasScrolledPast ? "sticky" : "relative"} top-0 h-screen`}
    >
      <div
        className="bg-linear-to-br from-[#000000] via-[#0F2248] to-[#1E448F] h-screen flex rounded-lg overflow-hidden"
      ...
      >
        ...
        >
            ...
            >
              ...
              >
                ...
                <div className="shortSummary-section flex-1 flex items-center text-white text-[15px] font-poppins px-4 py-4 overflow-hidden">
                  <p className="line-clamp-4 text-left">{event.shortSummary}</p>
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="w-full h-[15vh] shrink-0" id="bottom-spacer">
            {/* Empty spacer */}
          </div>
        </div>
