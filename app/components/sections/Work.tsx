  ...
  return (
    <div className="absolute w-[95%] h-[95%] z-20">
      <div className="relative w-full h-full">
        {/* 1 */}
        <div className="absolute w-[500px] h-80 top-0 left-0 overflow-hidden">
          <Image
            src={imgAt(0).src}
            alt={imgAt(0).alt}
            fill
      ...
      leading-[26.2px] tracking-[1.1px] top-15 left-[45%]"
        ...
        {/* 2 */}
        <div className="absolute w-[106px] h-[106px] top-40 right-0 overflow-hidden">
          <Image
            src={imgAt(1).src}
            alt={imgAt(1).alt}
            fill
      ...
      {/* 3 */}
      <div className="absolute w-[171px] h-[171px] left-[15%] top-[17%] overflow-hidden">
        <Image
          src={imgAt(2).src}
          alt={imgAt(2).alt}
          fill
      ...
      {/* 4 */}
      <div className="absolute w-[300px] h-60 top-[25%] right-0 overflow-hidden">
        <Image
          src={imgAt(3).src}
          alt={imgAt(3).alt}
          fill
      ...
      {/* 5 */}
      <div className="absolute w-50 h-70 top-[25%] left-10 overflow-hidden">
        <Image
          src={imgAt(4).src}
          alt={imgAt(4).alt}
          fill
      ...
      {/* 6 */}
      <div className="absolute w-[450px] h-70 top-[30%] left-[30%] overflow-hidden">
        <Image
          src={imgAt(5).src}
          alt={imgAt(5).alt}
          fill
      ...
      {/* 7 */}
      <div className="absolute w-[206px] h-[206px] top-[45%] right-30 overflow-hidden">
        <Image
          src={imgAt(6).src}
          alt={imgAt(6).alt}
          fill
      ...
      {/* 8 */}
      <div className="absolute w-[550px] h-90 top-[48%] left-0 overflow-hidden">
        <Image
          src={imgAt(7).src}
          alt={imgAt(7).alt}
          fill
      ...
      {/* 9 */}
      <div className="absolute w-[550px] h-90 top-[57%] left-0 overflow-hidden">
        <Image
          src={imgAt(8).src}
          alt={imgAt(8).alt}
          fill
      ...
      {/* 10 */}
      <div className="absolute w-[200px] h-60 top-[65%] right-0 overflow-hidden">
        <Image
          src={imgAt(9).src}
          alt={imgAt(9).alt}
          fill
      ...
      {/* 11 */}
      <div className="absolute w-[300px] h-60 top-[70%] left-30 overflow-hidden">
        <Image
          src={imgAt(10).src}
          alt={imgAt(10).alt}
          fill
      ...
      {/* 12 */}
      <div className="absolute w-[550px] h-90 top-[82%] right-0 overflow-hidden">
        <Image
          src={imgAt(11).src}
          alt={imgAt(11).alt}
          fill
      ...
      {/* 13 */}
      <div className="absolute w-[450px] h-60 top-[87%] left-10 overflow-hidden">
        <Image
          src={imgAt(12).src}
          alt={imgAt(12).alt}
          fill
      ...
      {/* 14 */}
      <div className="absolute w-[150px] h-[150px] top-[96%] right-10 overflow-hidden">
        <Image
          src={imgAt(13).src}
          alt={imgAt(13).alt}
          fill
