...
export const BlogsAnimation = () => {
  ...
  if (error) {
    return (
      <section className="w-full h-screen flex flex-col justify-center items-center text-white gap-4">
            ...
            >
              ...
              <div className="flex flex-row gap-13">
                ...
                <p className="text-[#9AA0A6] font-poppins text-[15px] font-normal leading-normal">
                  <span className="text-[#9AA0A6]">By </span>
                  <span className="text-[#0080FF]">
                    {blogs[activeIndex].author?.name || "Unknown"}
                  </span>
                </p>
                    ...
                    >
                      ...
                      <div className="mt-7 flex flex-row gap-13">
                        <p className="font-poppins text-[15px] font-normal leading-normal">
                          By{" "}
                          <span className="text-[#0080FF] ml-3 mr-1">
