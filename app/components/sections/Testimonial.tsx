...
export const Testimonial = () => {
    ...
    const testimonials: Testimonial[] = [
        {
            quote: "The future of computing in Sri Lanka is bright. And it's being built right here.",
        ...
        {
            quote: "The next generation of tech leaders is emerging from this vibrant community of learners and innovators.",
    ...
    return (
        <section className="relative min-h-screen w-full overflow-hidden py-20 md:py-32">
            ...
            <div
                ...
                style={{
                    background: "#000000",
                    background: "linear-gradient(90deg,rgba(0, 0, 0, 1) 36%, rgba(36, 91, 163, 1) 100%)"
                }}
            />

            {/* Decorative Left Boxes - 2 columns, 3 rows */}
            <motion.div className="absolute left-0  top-0 h-full w-1/3 hidden lg:grid grid-cols-2 grid-rows-3 gap-3 p-2 z-10"
            style={{ transform: "translateX(-80px)" }}>
                ...
                <motion.div
                    ...
                    style={{
                        ...
                        boxShadow: "0 0 40px rgba(40, 92, 151, 0.6), 0 0 80px rgba(40, 92, 151, 0.3)"
                    }}
                >
