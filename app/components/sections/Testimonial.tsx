...
export const Testimonial = () => {
    ...
    return (
        <section className="relative min-h-screen w-full overflow-hidden py-20 md:py-32">
            ...
            <motion.div
                className="absolute left-0  top-0 h-full w-1/3 hidden lg:grid grid-cols-2 grid-rows-3 gap-3 p-2 z-30"
                    ...
                    <div className="lg:hidden mb-8 w-full flex justify-center relative h-48">
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                exit={{ y: -100, opacity: 0 }}
                                transition={{ duration: 0.5, ease: "easeInOut" }}
                                className="absolute w-40 h-40 sm:w-48 sm:h-48 rounded-2xl overflow-hidden border-4 border-white/20 group"
                            >
                                <Image
                                    src={testimonials[currentIndex].image}
                                    alt={testimonials[currentIndex].author}
