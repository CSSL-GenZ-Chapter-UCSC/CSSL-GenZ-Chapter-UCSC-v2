...
export const About = () => {
  return (
    <section className="h-screen flex items-start justify-center bg-black text-white pt-25">
      <Container className="h-full">
        <div className="w-full h-full flex flex-col items-stretch">
          ...
          <div className="flex justify-between items-end self-stretch flex-1 mb-20">
            {[...Array(8)].map((_, i) => (
              <div key={i} className="w-[134px] h-[134px] bg-gray-500" />
            ))}
          </div>
        </div>
      </Container>
