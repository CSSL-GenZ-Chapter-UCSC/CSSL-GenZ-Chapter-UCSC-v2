...
const announcements: Announcement[] = [
    {
        ...
        message: "Portal will be down for upgrades until the 26th of November 2025",
    },
    {
        id: "2",
        label: "NEWS",
        title: "GenZ Chapter Launch",
        message: "Join us for the official launch event on December 1st!",
    },
];
